let btnEdit = document.getElementById('btnSubEdit');
let val1 = document.getElementById('validation01');
let val2 = document.getElementById('validation02');
let val3 = document.getElementById('validation03');
document.getElementById('editProf').addEventListener('click', function () {
    btnEdit.removeAttribute('hidden');
    val1.removeAttribute('readonly');
    val2.removeAttribute('readonly');
    val3.removeAttribute('readonly');
});
