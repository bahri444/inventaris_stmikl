            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 mt-md-0 mt-4">
                        <h6 class="mb-4 text-white">Website</h6>
                        <ul class="m-0 p-0 list-unstyled text-white">
                            <li class="mb-3"><a href="https://stmiklombok.ac.id/" class="text-light">STMIK Lombok</a></li>
                            <li class="mb-3"><a href="https://pmb.stmiklombok.ac.id/index.php/home/info_pmb" class="text-light">PMB STMIK Lombok</a></li>
                            <li class="mb-3"><a href="https://e-journal.stmiklombok.ac.id/index.php/jire" class="text-light">JIRE STMIK Lombok</a></li>
                            <li class="mb-3"><a href="https://www.sika.stmiklombok.ac.id/" class="text-light">SIAKAD</a></li>
                        </ul>
                    </div>
