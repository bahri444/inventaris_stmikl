...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{asset('assetslandingpage')}}/images/favicon.ico" />

    <!-- Library / Plugin Css Build -->
    <link rel="stylesheet" href="{{asset('assetslandingpage')}}/css/core/libs.min.css" />

    <!-- Hope Ui Design System Css -->
    <link rel="stylesheet" href="{{asset('assetslandingpage')}}/css/hope-ui.min.css?v=2.0.0" />

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{asset('assetslandingpage')}}/css/custom.min.css?v=2.0.0" />

    <!-- Dark Css -->
    <link rel="stylesheet" href="{{asset('assetslandingpage')}}/css/dark.min.css" />

    <!-- Customizer Css -->
    <link rel="stylesheet" href="{{asset('assetslandingpage')}}/css/customizer.min.css" />

    <!-- RTL Css -->
    <link rel="stylesheet" href="{{asset('assetslandingpage')}}/css/rtl.min.css" />
...
<body class=" body-bg landing-pages">
            ...
            <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
                <div class="container-fluid navbar-inner">
                    <div class="d-flex align-items-center justify-content-between w-100 landing-header">
                        <h5 class="logo-title">STMIK LOMBOK</h5>
                        </a>
                        ...
                        <nav id="navbar_main" class="mobile-offcanvas nav navbar navbar-expand-xl hover-nav horizontal-nav">
                            <div class="container-fluid p-lg-0">
                                ...
                                <ul class="navbar-nav" id="header-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link " href="/visimisiti">Teknik informatika</a></li>
                                    <li class="nav-item"><a class="nav-link " href="/visimisisi">Sistem informasi</a></li>
                                </ul>
                            </div> <!-- container-fluid.// -->
                        </nav>
                        <!-- Sidebar Menu End -->
    ...
    <footer>
        <div class="bg-secondary inner-box ">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <a href="{{asset('assetslandingpage')}}//dashboard/index.html" class="navbar-brand  d-flex align-items-center">
                            ...
                            <h6 class="logo-title ms-3 text-white">STMIK LOMBOK</h6>
                        </a>
                        <p class="text-white my-4">Sekolah Tinggi Manajemen Informatika dan Kompute (STMIK) Lombok. </p>
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <p class="m-4 mb-0 text-white">Jalan Basuki Rahmat Praya Mataram, <br> Praya, Kec. Praya, Kabupaten Lombok Tengah, <br> Nusa Tenggara Bar. 83511</p>
                        </div>
                    ...
                    <div class="col-md-4 mt-md-0 mt-4">
                        <h6 class="mb-4 text-white">Socials media</h6>
                        <div class="input-group mb-4">
                            <span class="input-group-text input-email-btn" id="basic-addon1">
                                <p>follow and add my social media</p>
                            </span>
                        </div>
                        <ul class="list-unstyled p-0 m-0 d-flex mt-4">
                            <li>
                                <a href="#"><img src="{{asset('assetslandingpage')}}/images/brands/08.png" alt="fb" loading="lazy" class="rounded-pill"></a>
                            </li>
                            <li class="ps-3">
                                <a href="#"><img src="{{asset('assetslandingpage')}}/images/brands/09.png" alt="gm" loading="lazy" class="rounded-pill"></a>
                            </li>
                            <li class="ps-3">
                                <a href="#"><img src="{{asset('assetslandingpage')}}/images/brands/10.png" alt="im" loading="lazy" class="rounded-pill"></a>
                            </li>
                            <li class="ps-3">
                                <a href="#"><img src="{{asset('assetslandingpage')}}/images/brands/13.png" alt="li" loading="lazy" class="rounded-pill"></a>
                            </li>
                        </ul>
                    </div>
                    <hr>
                ...
                <div class="row">
                    <div class="col-md-12 text-center text-white">
                        <p class="mb-0">©
                            ...
                            </script> Inventaris STMIK Lombok, All Rights Reserved.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script src="{{asset('assetslandingpage')}}/js/core/libs.min.js"></script>

    <!-- External Library Bundle Script -->
    <script src="{{asset('assetslandingpage')}}/js/core/external.min.js"></script>

    <!-- fslightbox Script -->
    <script src="{{asset('assetslandingpage')}}/js/plugins/fslightbox.js"></script>

    <!-- Settings Script -->
    <script src="{{asset('assetslandingpage')}}/js/plugins/setting.js"></script>

    <!-- Slider-tab Script -->
    <script src="{{asset('assetslandingpage')}}/js/plugins/slider-tabs.js"></script>

    <!-- Form Wizard Script -->
    <script src="{{asset('assetslandingpage')}}/js/plugins/form-wizard.js"></script>

    <!-- AOS Animation Plugin-->

    <!-- App Script -->
    <script src="{{asset('assetslandingpage')}}/js/hope-ui.js" defer></script>


    <!-- SwiperSlider Script -->
    <script src="{{asset('assetslandingpage')}}/vendor/swiperSlider/swiper-bundle.min.js"></script>
    <script src="{{asset('assetslandingpage')}}/landing-pages/js/app-landing.js" defer></script>
</body>
